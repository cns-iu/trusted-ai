SELECT a.element_id, a.element_name, a.descr, a.groups AS root, left(a.element_id,5) AS lvl_1, 
...
SELECT a.element_id, a.element_name, a.descr, a.groups as root, left(a.element_id,5) AS lvl_1, c.element_name AS lvl_1_label, NULL AS lvl_2, NULL as lvl_2_label
FROM public.elements AS a
LEFT JOIN public.elements AS c
ON c.element_id = left(a.element_id,5)
